...
const AddStudentModal = ({ open, onClose }) => {
    ...
    useEffect(() => {
        fetch('https://spring-csdrms-g8ra.onrender.com/class/allUniqueGrades')
            .then((response) => response.json())
            .then((data) => setGrades(data))
            .catch((error) => console.error('Error fetching grades:', error));

        fetch('https://spring-csdrms-g8ra.onrender.com/schoolYear/getAllSchoolYears')
            .then((response) => response.json())
    ...
    useEffect(() => {
        if (studentData.grade) {
            fetch(`https://spring-csdrms-g8ra.onrender.com/class/sections/${studentData.grade}`)
                .then((response) => response.json())
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        fetch(`https://spring-csdrms-g8ra.onrender.com/student/insertStudent/${loggedInUser.userId}`, {
            method: 'POST',
            headers: {
